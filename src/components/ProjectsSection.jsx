...
const ProjectCard = ({ project }) => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-zinc-900 rounded-lg p-6 shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] w-full max-w-4xl mx-auto mb-8">
      ...
      <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-8 w-full md:w-1/2">
        <img
          ...
          onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/600x400/1e293b/cbd5e1?text=Imagem+Nao+Encontrada'; }}
        />
      </div>
        ...
        <div className="flex space-x-6">
          ...
          {project.githubUrl && (
            <a
              ...
              title="Ver no GitHub"
            >
              <FaGithub className="m-1 text-2xl" /> <span className="text-lg">GitHub</span>
            </a>
          )}
        </div>
      </div>
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 w-full">
        ...
        <div className="w-full text-center lg:text-left mt-6 text-teal-700">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-teal-700 mt-6">
            Meus Projetos
          </h1>
